var _excluded = ["labels"],
  _excluded2 = ["suites", "duration", "retries"],
  _excluded3 = ["resultsDir", "videoOnFailOnly"];
...
import { ReporterRuntime, createDefaultWriter, getEnvironmentLabels, getFrameworkLabel, getHostLabel, getLanguageLabel, getPackageLabel, getSuiteLabels, getThreadLabel, parseTestPlan } from "allure-js-commons/sdk/reporter";
...
export class AllureCypress {
  constructor() {
    ...
    _classPrivateFieldInitSpec(this, _startTest, (context, _ref6) => {
      ...
      context.test = _classPrivateFieldGet(_addNewTestResult, this).call(this, context, data, [context.videoScope, ...context.suiteScopes, testScope]);
    });
    _classPrivateFieldInitSpec(this, _addNewTestResult, (context, _ref7, scopes) => {
      var {
          labels: metadataLabels = []
        } = _ref7,
        otherTestData = _objectWithoutProperties(_ref7, _excluded);
    ...
    _classPrivateFieldInitSpec(this, _addSkippedTest, (context, _ref10) => {
      var {
        ...
        testResultData = _objectWithoutProperties(_ref10.data, _excluded2);
      ...
      var testUuid = _classPrivateFieldGet(_addNewTestResult, this).call(this, context, testResultData, [context.videoScope, ...scopes]);
    ...
    _classPrivateFieldInitSpec(this, _startCommand, (context, _ref13) => {
      var {
        data: {
          name,
          args
    ...
    _classPrivateFieldInitSpec(this, _stopCommand, (context, _ref14) => {
      var {
        data: {
          status,
          statusDetails,
