...
var flushRuntimeMessages = () => getTestRuntime().flushAllureMessagesToTask("reportAllureCypressSpecMessages");
exports.flushRuntimeMessages = flushRuntimeMessages;
var completeSpec = () => getTestRuntime().flushAllureMessagesToTaskAsync("reportFinalAllureCypressSpecMessages");
exports.completeSpec = completeSpec;
...
var reportTestsSkippedByHookError = (test, testFailData) => {
  (0, _state.enqueueRuntimeMessage)({
    ...
    data: _objectSpread(_objectSpread(_objectSpread(_objectSpread({}, (0, _utils.getTestStartData)(test)), testFailData), (0, _utils.getTestStopData)(test)), {}, {
      suites: (0, _utils.getSuites)(test).map(s => s.id)
    })
  });
  (0, _utils.markTestAsReported)(test);
};
...
var wrapAfterFnWithoutArgs = fn => {
  return function () {
    ...
    } else if ((0, _sdk.isPromise)(result)) {
